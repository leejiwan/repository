...
const mavelAddress = 'https://gateway.marvel.com:443/v1/public/';
const serverAddress = 'http://115.85.180.140:3000/';

export { ts, apiKey, privateKey, mavelAddress, serverAddress };